...
// let code = omggif_code.toString();
// code = code.substring(code.indexOf("{")+1, code.lastIndexOf("}"));

// const blob = new Blob([code], {type: "application/javascript"});
// const omggif_worker = URL.createObjectURL(blob);

// export default omggif_worker;
export default omggif_code;